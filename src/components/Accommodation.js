...
//       <div className="p-3 col-10 col-lg-6 fs-5">
...
//       />
//       <br></br>
//       <button className="mt-4 mb-4 btn btn-warning border-2 border-dark rounded" onClick={handleSearch}>
//         Search
//       </button>
...
//               <div className='acc-box text-center rounded m-2 p-3 mt-4 mb-2 col-10 col-md-4 col-lg-4'>
//                 <h4>{result.Name}</h4>
//                 <p>{result.Tags}</p>
...
//             let href = result.Url;
//             return (
//               <div className='acc-box text-center rounded m-2 p-4 mt-4 mb-2 col-10 col-md-4 col-lg-4'>
//                 <h4>{result.Name}</h4>
//                 <p>{result.Tags}</p>
//                 <a href={href} target='_blank' rel="noreferrer">
//                   {result.Url}
...
//               );
//             })
//           ) : ( searchTerm !== '' && isVisible && <p>You entered a town name, enter a city name to search by city.</p> )}
//         </div>
//       </div>
//     </div>
//   );
...
//     if (filteredResults.length === 0 && searchTerm !== '' && isVisible) {
...
//         return (
//           <div
//             className='acc-box text-center rounded m-2 p-3 mt-4 mb-2 col-10 col-md-4 col-lg-4'
//             key={result.id}
//           >
//             <h4>{result.Name}</h4>
//             <p>{result.Tags}</p>
...
//       return <p>You entered a town name, enter a city name to search by city.</p>;
//     }
